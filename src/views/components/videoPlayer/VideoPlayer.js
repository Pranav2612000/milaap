...
export default class VideoPlayer extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (videoPlayerIsLoaded && internalVideoPlayer && !userIsBuffering) {
      ...
      this.handleInitialPlayerStateSynchronization(
  ...
  render() {
    ...
    const videoDuration =
      videoPlayer && videoPlayerIsLoaded ? videoPlayer.getDuration() : null;
    ...
    return (
      <div className={videoPlayerClassNames}>
        <ReactPlayer
          ...
          onPause={() =>
            onPlayerStateChange(this.constructUserPlayerState('paused', videoPlayer))
          }
          onBuffer={() =>
            onPlayerStateChange(
