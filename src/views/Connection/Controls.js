                ...
                .then((media) => {
                  ...
                  call.on("stream", function (stream) {
                    ...
                    store.addNotification({
                      title: "Member joined",
                      message: `${call.peer} has joined the call`,
                      type: "info",
                      insert: "top",
                      container: "top-right",
        ...
        self.setState(
          ...
          () => {
            ...
            thiscall.on("stream", function (stream) {
              ...
              store.addNotification({
                title: "Member joined",
                message: `${friendtkn} has joined the call`,
                type: "info",
                insert: "top",
                container: "top-right",
                animationIn: ["animated", "fadeIn"],
      ...
      <Container>
        ...
        <Row>
          ...
          <Col className="col-sm">
            <ButtonGroup>
              <Button className="btn btn-info" onClick={this.startScreenShare}>
                Screen
              </Button>
              <Button className="btn btn-success" onClick={this.startVideo}>
                Video
              </Button>
            </ButtonGroup>
          </Col>
