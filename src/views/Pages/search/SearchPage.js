...
// Actions
import { videoListActions } from '../../../redux/videoList/index';
...
class SearchPage extends Component {
  ...
  render() {
    const currentQuery = this.props.params.query ? this.props.params.query : '';
    const { handleVideoSelection } = this.props.handleVideoSelection;

    return (
      <div className="browse-page">
        <PageHeader titleLeader="Search results" titleMain={currentQuery} />
