    ...
    return (
      <React.Fragment>
        ...
        <Nav className="d-md-down-none" navbar>
          ...
          <NavItem className="px-3">
            <NavLink to="#" className="nav-link" onClick={this.toggle}>Add Friends</NavLink>
          </NavItem>
        </Nav>
                          ...
                          <Form>
                              <InputGroup className="mb-3">
                                ...
                                <Input type="text" placeholder="Username" autoComplete="username" 
                                      value = {this.state.friendid} onChange={this.handleFriendChange}/>
                              </InputGroup>
                              <InputGroup className="mb-3">
                                <InputGroupAddon addonType="prepend">
                                  <InputGroupText>
                                ...
                                <Input type="text" placeholder="Room Name" autoComplete="roomname" 
