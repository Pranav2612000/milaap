    ...
    iSxC: [
      function (require, module, exports) {
        ...
        function detectBrowser(window) {
          var { navigator } = window; // Returned result object.
      ...
      function (require, module, exports) {
        ...
        function writeMediaSection(transceiver, caps, type, stream, dtlsRole) {
          ...
          if (transceiver.rtpSender) {
            ...
            sdp +=
              'a=ssrc:' + transceiver.sendEncodingParameters[0].ssrc + ' ' + msid; // RTX
        ...
        function shimMaxMessageSize(window) {
          ...
          window.RTCPeerConnection.prototype.setRemoteDescription = function setRemoteDescription() {
            ...
            if (
              ...
              var { sdpSemantics } = this.getConfiguration();
        ...
        var DataConnection =
          ...
          (function (_super) {
            ...
            DataConnection.prototype._trySend = function (msg) {
              ...
              if (
                this.dataChannel.bufferedAmount > DataConnection.MAX_BUFFERED_AMOUNT
              ) {
