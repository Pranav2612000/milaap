parcelRequire = (function (e, r, t, n) {
  var i;
  var o = typeof parcelRequire === 'function' && parcelRequire;
...
})(
  {
    ...
    kdPp: [
      function (require, module, exports) {
        ...
        var e = require('./bufferbuilder').binaryFeatures;
        var i = {
          unpack: function (t) {
        ...
        (module.exports = i),
          ...
          (r.prototype.unpack_uint16 = function () {
            var t = this.read(2);
            var e = 256 * (255 & t[0]) + (255 & t[1]);
            return (this.index += 2), e;
          }),
          (r.prototype.unpack_uint32 = function () {
            var t = this.read(4);
            var e = 256 * (256 * (256 * t[0] + t[1]) + t[2]) + t[3];
          ...
          (n.prototype.pack = function (t) {
            var i = typeof t;
            if (i === 'string') this.pack_string(t);
            else if (i === 'number')
            ...
            else if (i === 'undefined') this.bufferBuilder.append(192);
            else {
              if (i !== 'object')
                throw new Error('Type "' + i + '" not yet supported');
              if (t === null) this.bufferBuilder.append(192);
              else {
                var r = t.constructor;
                if (r == Array) this.pack_array(t);
                  ...
                  if (typeof t.toBinaryPack !== 'function')
          ...
          (n.prototype.pack_double = function (t) {
            ...
            var r = t / Math.pow(2, i) - 1;
            var n = Math.floor(r * Math.pow(2, 52));
            var u = Math.pow(2, 32);
            var a = (e << 31) | ((i + 1023) << 20) | ((n / u) & 1048575);
            var p = n % u;
    ...
    iSxC: [
      function (require, module, exports) {
        ...
        function u() {
          if (
            (typeof window === 'undefined' ? 'undefined' : t(window)) === 'object'
          ) {
            if (n) return;
        ...
        function b(e, t, n) {
          ...
          return (
            e.forEach(function (e) {
              e.type === 'track' && e.trackIdentifier === t.id && i.push(e);
            }),
      ...
      function (require, module, exports) {
        ...
        function i(r) {
          ...
          if (t.mediaDevices) {
            ...
            var a = function (e) {
              if (o(e) !== 'object' || e.mandatory || e.optional) return e;
              var r = {};
              return (
                Object.keys(e).forEach(function (t) {
                  if (t !== 'require' && t !== 'advanced' && t !== 'mediaSource') {
                    var n = o(e[t]) === 'object' ? e[t] : { ideal: e[t] };
                    void 0 !== n.exact &&
            ...
            var c = function (e, r) {
              ...
              if ((e = JSON.parse(JSON.stringify(e))) && o(e.audio) === 'object') {
              ...
              if (e && o(e.video) === 'object') {
                var d = e.video.facingMode;
                d = d && (o(d) === 'object' ? d : { ideal: d });
                var u;
                var s = i.version < 66;
                if (
                  d &&
              ...
              (typeof i === 'function'
                ? (e.navigator.mediaDevices.getDisplayMedia = function (a) {
                    return i(a).then(function (i) {
                      ...
                      var o = a.video && a.video.height;
                      var d = a.video && a.video.frameRate;
                      return (
                        (a.video = {
                          mandatory: {
    ...
    uI5X: [
      function (require, module, exports) {
        ...
        var t = require('./getusermedia');
        var r = require('./getdisplaymedia');
        function n() {
          if (typeof WeakMap !== 'function') return null;
          var e = new WeakMap();
          return (
        ...
        function d(e) {
          if (e.RTCPeerConnection) {
            ...
            e.RTCPeerConnection.prototype.getStats = function () {
              ...
              if (
                t.length === 0 &&
                (arguments.length === 0 || typeof r !== 'function')
              )
                return t.apply(this, []);
              var o = function (e) {
                var t = {};
          ...
          e.RTCPeerConnection.prototype.addTrack = function (e, r) {
            ...
            return (
              this._shimmedLocalStreams[r.id]
                ? this._shimmedLocalStreams[r.id].indexOf(n) === -1 &&
            ...
            return (
              ...
              e &&
                Object.keys(this._shimmedLocalStreams).forEach(function (r) {
                  ...
                  n !== -1 && t._shimmedLocalStreams[r].splice(n, 1),
                    t._shimmedLocalStreams[r].length === 1 &&
          ...
          if (
            ...
            r.version < 53 &&
              [
                ...
                var n = o({}, e, function () {
                  return (
                    (arguments[0] = new (e === 'addIceCandidate'
                      ? t.RTCIceCandidate
        ...
        function l(t) {
          e.wrapPeerConnectionEvent(t, 'negotiationneeded', function (e) {
            if (e.target.signalingState === 'stable') return e;
          });
        }
      },
      {
      ...
      function (require, module, exports) {
        ...
        (r.localCName = r.generateIdentifier()),
          ...
          (r.parseRtpMap = function (r) {
            ...
            var t = { payloadType: parseInt(e.shift(), 10) };
            return (
              (e = e[0].split('/')),
              (t.name = e[0]),
              (t.clockRate = parseInt(e[1], 10)),
              (t.channels = e.length === 3 ? parseInt(e[2], 10) : 1),
          ...
          (r.parseSsrcMedia = function (r) {
            var e = r.indexOf(' ');
            var t = { ssrc: parseInt(r.substr(7, e - 7), 10) };
            var n = r.indexOf(':', e);
            return (
              n > -1
          ...
          (r.getIceParameters = function (e, t) {
            ...
            return {
              usernameFragment: (n = n.concat(r.splitLines(t)))
                .filter(function (r) {
                  return r.indexOf('a=ice-ufrag:') === 0;
                })[0]
                .substr(12),
              password: n
                .filter(function (r) {
                  return r.indexOf('a=ice-pwd:') === 0;
                })[0]
                .substr(10)
            };
          }),
          ...
          (r.parseRtpParameters = function (e) {
            for (
              ...
              var s = n[a];
              var i = r.matchPrefix(e, 'a=rtpmap:' + s + ' ')[0];
              if (i) {
          ...
          (r.parseRtpEncodingParameters = function (e) {
            var t;
            var n = [];
            var a = r.parseRtpParameters(e);
            var s = a.fecMechanisms.indexOf('RED') !== -1;
            var i = a.fecMechanisms.indexOf('ULPFEC') !== -1;
            var p = r
            ...
            var c = p.length > 0 && p[0].ssrc;
            var o = r.matchPrefix(e, 'a=ssrc-group:FID').map(function (r) {
              return r
                .substr(17)
                .split(' ')
                .map(function (r) {
            ...
            o.length > 0 && o[0].length > 1 && o[0][0] === c && (t = o[0][1]),
              a.codecs.forEach(function (r) {
                if (r.name.toUpperCase() === 'RTX' && r.parameters.apt) {
                  var e = {
                    ssrc: c,
          ...
          (r.parseRtcpParameters = function (e) {
            ...
            (t.reducedSize = a.length > 0), (t.compound = a.length === 0);
          ...
          (r.parseSctpDescription = function (e) {
            var t;
            var n = r.parseMLine(e);
            var a = r.matchPrefix(e, 'a=max-message-size:');
          ...
          typeof module === 'object' && (module.exports = r);
      },
      {}
    ],
    NJ2u: [
        ...
        module.exports = function (c, d) {
          ...
          var f = function (t) {
            ...
            if (
              ...
              (this.usingBundle = t.bundlePolicy === 'max-bundle'),
              t.rtcpMuxPolicy === 'negotiate')
            )
              throw o(
                'NotSupportedError',
          ...
          Object.defineProperty(f.prototype, 'localDescription', {
            ...
            (f.prototype.addTrack = function (e, t) {
              ...
              return (
                ...
                this.localStreams.indexOf(t) === -1 && this.localStreams.push(t),
                (r.track = e),
                (r.stream = t),
            ...
            (f.prototype._createIceGatherer = function (e, t) {
              ...
              return (
                ...
                (this.transceivers[e].bufferCandidates = function (t) {
                  var a = !t.candidate || Object.keys(t.candidate).length === 0;
                  (n.state = a ? 'completed' : 'gathering'),
                    r.transceivers[e].bufferedCandidateEvents !== null &&
            ...
            (f.prototype._gather = function (t, r) {
              var n = this;
              var a = this.transceivers[r].iceGatherer;
                ...
                (this.transceivers[r].bufferedCandidateEvents = null),
                  ...
                  (a.onlocalcandidate = function (i) {
                    if (!(n.usingBundle && r > 0)) {
                      ...
                      var o = i.candidate;
                      var c = !o || Object.keys(o).length === 0;
                      if (c)
                        (a.state !== 'new' && a.state !== 'gathering') ||
                          (a.state = 'completed');
                      else {
                        a.state === 'new' && (a.state = 'gathering'),
                          (o.component = 1),
                      ...
                      (p[s.candidate.sdpMLineIndex] += c
                        ...
                        (n._localDescription.sdp =
                          e.getDescription(n._localDescription.sdp) + p.join(''));
            ...
            (f.prototype._createIceAndDtlsTransports = function () {
              var e = this;
              var t = new c.RTCIceTransport(null);
            ...
            (f.prototype.setLocalDescription = function (t) {
              ...
              var n;
              var s = this;
              if (['offer', 'answer'].indexOf(t.type) === -1)
              ...
              if (!i('setLocalDescription', t.type, s.signalingState) || s._isClosed)
                return Promise.reject(
                  o(
                    'InvalidStateError',
                    'Can not set local ' + t.type + ' in state ' + s.signalingState
                  )
                );
              if (t.type === 'offer')
                ...
                r.forEach(function (t, r) {
                  ...
                  var o = i.iceGatherer;
                  var d = i.iceTransport;
                  var p = i.dtlsTransport;
                  var l = i.localCapabilities;
                  var f = i.remoteCapabilities;
                  if (
                    !(
                      e.isRejected(t) &&
                      e.matchPrefix(t, 'a=bundle-only').length === 0
                    ) &&
                    !i.rejected
                  ) {
                    var u = e.getIceParameters(t, n);
                    var v = e.getDtlsParameters(t, n);
                    c && (v.role = 'server'),
                      (s.usingBundle && r !== 0) ||
                        (s._gather(i.mid, r),
                        d.state === 'new' &&
                          d.start(o, u, c ? 'controlling' : 'controlled'),
                        p.state === 'new' && p.start(v));
                    var h = a(l, f);
            ...
            (f.prototype.setRemoteDescription = function (t) {
              ...
              if (
                ...
                return Promise.reject(
                  o(
                    'InvalidStateError',
                    'Can not set remote ' + t.type + ' in state ' + r.signalingState
                  )
                );
              var n = {};
              ...
              var f = [];
              var u = e.splitSections(t.sdp);
              var v = u.shift();
              var h = e.matchPrefix(v, 'a=ice-lite').length > 0;
              var m = e.matchPrefix(v, 'a=group:BUNDLE ').length > 0;
              r.usingBundle = m;
              ...
              return (
                ...
                u.forEach(function (i, o) {
                  ...
                  var g =
                    e.isRejected(i) &&
                    e.matchPrefix(i, 'a=bundle-only').length === 0;
                  var y = l[0].substr(2).split(' ')[2];
                  var S = e.getDirection(i, v);
                  var T = e.parseMsid(i);
                  var E = e.getMid(i) || e.generateIdentifier();
                  if (
                    g ||
                    (u === 'application' &&
                      (y === 'DTLS/SCTP' || y === 'UDP/DTLS/SCTP'))
                  )
                    r.transceivers[o] = {
                      mid: E,
                      kind: u,
                    ...
                    var G = e.matchPrefix(i, 'a=end-of-candidates', v).length > 0;
                    var j = e
                    ...
                    if (
                      ...
                      if (t.type === 'answer' && !g) {
                        (P = (C = r.transceivers[o]).iceGatherer),
                          ...
                          (m && o !== 0) ||
                            (w.state === 'new' && w.start(P, I, 'controlling'),
                            R.state === 'new' && R.start(L)),
                          !a(
                            C.localCapabilities,
                          ...
                          r._transceive(
                            C,
                            S === 'sendrecv' || S === 'recvonly',
                            S === 'sendrecv' || S === 'sendonly'
                          ),
                          !_ || (S !== 'sendrecv' && S !== 'sendonly')
                      ...
                      if (S === 'sendrecv' || S === 'sendonly') {
                        ...
                        C.rtpReceiver &&
                          ...
                          (C.associatedRemoteMediaStreams.forEach(function (e) {
                            var t;
                            var r;
                            var n = e.getTracks().find(function (e) {
                ...
                void 0 === r._dtlsRole &&
                  (r._dtlsRole = t.type === 'offer' ? 'active' : 'passive'),
                ...
                Object.keys(n).forEach(function (e) {
                  ...
                  if (t.getTracks().length) {
                    if (r.remoteStreams.indexOf(t) === -1) {
            ...
            (f.prototype.createOffer = function () {
              ...
              var a = t.transceivers.filter(function (e) {
                return e.kind === 'video';
              }).length;
              var i = arguments[0];
              if (i) {
              ...
              t.transceivers.forEach(function (r, n) {
                var a = r.track;
                var i = r.kind;
                var s = r.mid || e.generateIdentifier();
                (r.mid = s),
                  r.iceGatherer ||
                ...
                t._config.bundlePolicy !== 'max-compat' &&
                  (s +=
                    'a=group:BUNDLE ' +
                    t.transceivers
                      .map(function (e) {
            ...
            (f.prototype.createAnswer = function () {
              ...
              if (
                t.signalingState !== 'have-remote-offer' &&
                t.signalingState !== 'have-local-pranswer'
              )
                return Promise.reject(
                  o(
                    'InvalidStateError',
                    'Can not call createAnswer in signalingState ' + t.signalingState
                  )
                );
                ...
                if (!(s + 1 > i)) {
                  ...
                  if (e.stream)
                    e.kind === 'audio'
                      ...
                      : e.kind === 'video' && (o = e.stream.getVideoTracks()[0]),
                      o &&
                        d >= 15019 &&
                        e.kind === 'video' &&
                        !e.sendEncodingParameters[0].rtx &&
                    ...
                    if (t && t.candidate !== '') {
                      ...
                      var l =
                        Object.keys(t.candidate).length > 0
                          ...
                          : {};
                      if (l.protocol === 'tcp' && (l.port === 0 || l.port === 9))
                        return a();
                      if (l.component && l.component !== 1) return a();
                      if (
                        (c === 0 ||
                          (c > 0 &&
                            p.iceTransport !== n.transceivers[0].iceTransport)) &&
                        !s(p.iceTransport, l)
                      )
                        return i(o('OperationError', 'Can not add ICE candidate'));
                      ...
                      f.indexOf('a=') === 0 && (f = f.substr(2)),
                        ...
                        (n._remoteDescription.sdp =
                          e.getDescription(n._remoteDescription.sdp) + r.join(''));
    ...
    XRic: [
      function (require, module, exports) {
        ...
        var t = require('./filtericeservers');
        var r = o(require('rtcpeerconnection-shim'));
        var n = require('./getusermedia');
        var i = require('./getdisplaymedia');
        function o(e) {
    ...
    Fzdr: [
      function (require, module, exports) {
        ...
        function s(t) {
          var r = e.detectBrowser(t);
          if (a(t) === 'object' && (t.RTCPeerConnection || t.mozRTCPeerConnection)) {
            if (
              (!t.RTCPeerConnection &&
            ...
            var c = t.RTCPeerConnection.prototype.getStats;
            t.RTCPeerConnection.prototype.getStats = function () {
              var [e, t, n] = arguments;
              return c
                .apply(this, [e || null])
    ...
    t1lL: [
      function (require, module, exports) {
        ...
        function n(e) {
          if (o(e) === 'object' && e.RTCPeerConnection) {
            if (
      ...
      function (require, module, exports) {
          ...
          if (
            ...
            (n.RTCIceCandidate = function (t) {
              if (
                ...
                var n = new o(t);
                var r = e.default.parseCandidate(t.candidate);
                var a = Object.assign(n, r);
                return (
                  (a.toJSON = function () {
                    return {
        ...
        function c(n) {
          if (n.RTCPeerConnection) {
            ...
            n.RTCPeerConnection.prototype.setRemoteDescription = function () {
              if (((this._sctp = null), o.browser === 'chrome' && o.version >= 76)) {
        ...
        function s(e) {
          ...
          function o(e, t) {
            ...
            e.send = function () {
              var o = arguments[0];
              var r = o.length || o.size || o.byteLength;
              if (e.readyState === 'open' && t.sctp && r > t.sctp.maxMessageSize)
                throw new TypeError(
        ...
        function u(e) {
          if (e.RTCPeerConnection) {
            ...
            if (!(n.browser === 'chrome' && n.version >= 71)) {
    ...
    KtlG: [
      function (require, module, exports) {
        ...
        var e = o(require('./utils'));
        var r = o(require('./chrome/chrome_shim'));
        var i = o(require('./edge/edge_shim'));
        var s = o(require('./firefox/firefox_shim'));
        var t = o(require('./safari/safari_shim'));
        var a = o(require('./common_shim'));
        function n() {
          if (typeof WeakMap !== 'function') return null;
          var e = new WeakMap();
          return (
    ...
    tI1X: [
      function (require, module, exports) {
        ...
        var r = (0, e.adapterFactory)({ window: window });
        var t = r;
        exports.default = t;
      },
        ...
        exports.Supports = new ((function () {
          ...
          return (
            ...
            (e.prototype.isBrowserSupported = function () {
              ...
              return (
                ...
                (r === 'chrome'
                  ...
                  : r === 'safari' && !this.isIOS && e >= this.minSafariVersion)
              );
            }),
            ...
            (e.prototype.isUnifiedPlanSupported = function () {
              ...
              var t = r.webRTCAdapter.browserDetails.version || 0;
              if (i === 'chrome' && t < 72) return !1;
              if (i === 'firefox' && t >= 59) return !0;
              if (
                !(
            ...
            if (c.fn)
              ...
              for (var f = 0, u = [], a = c.length; f < a; f++)
                (c[f].fn !== n || (o && !c[f].once) || (r && c[f].context !== r)) &&
                  u.push(c[f]);
              u.length ? (this._events[i] = u.length === 1 ? u[0] : u) : s(this, i);
            }
            return this;
          }),
        ...
        var a = (function () {
          ...
          return (
            ...
            (o.prototype._setupListeners = function (e) {
              var n = this;
              var t = this.connection.peer;
              var o = this.connection.connectionId;
              var a = this.connection.type;
              var s = this.connection.provider;
            ...
            (o.prototype.cleanup = function () {
              ...
              if (e) {
                ...
                var n = e.signalingState !== 'closed';
                var t = !1;
                if (this.connection.type === c.ConnectionType.Data) {
                  var o = this.connection.dataChannel;
                  o && (t = !!o.readyState && o.readyState !== 'closed');
                }
                (n || t) && e.close();
              }
            }),
                ...
                return t(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      return (
                        t.trys.push([1, 7, , 8]),
                        [4, n.createOffer(this.connection.options.constraints)]
                      );
                    case 2:
                      (a = t.sent()),
                        ...
                        this.connection.options.sdpTransform &&
                          typeof this.connection.options.sdpTransform ===
                            'function' &&
                          (a.sdp =
                            this.connection.options.sdpTransform(a.sdp) || a.sdp),
                        (t.label = 3);
                    case 3:
                      ...
                      (o = t.sent()),
                        ...
                        this.connection.options.sdpTransform &&
                          typeof this.connection.options.sdpTransform ===
                            'function' &&
                          (o.sdp =
                            this.connection.options.sdpTransform(o.sdp) || o.sdp),
                        (t.label = 3);
                    case 3:
              ...
              return n(this, void 0, Promise, function () {
                ...
                return t(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      return (
                        t.trys.push([1, 5, , 6]), [4, n.setRemoteDescription(o)]
                      );
                    case 2:
                      return (
                        t.sent(),
    ...
    dbHP: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 });
        var n = require('./util');
        var i = r(require('./logger'));
        var a = require('./negotiator');
        var s = require('./enums');
        var l = require('./baseconnection');
        var c = (function (r) {
          function l(e, t, o) {
    ...
    GBTQ: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 });
        var i = require('./util');
        var o = n(require('./logger'));
        var r = require('./negotiator');
        var a = require('./enums');
        var s = require('./baseconnection');
        var u = require('./encodingQueue');
        var l = (function (n) {
          function s(e, t, l) {
          ...
          return (
            ...
            (s.prototype._configureDataChannel = function () {
              ...
              (i.util.supports.binaryBlob && !i.util.supports.reliable) ||
                ...
                (this.dataChannel.onmessage = function (t) {
                  o.default.log('DC#' + e.connectionId + ' dc onmessage:', t.data),
                    e._handleDataMessage(t);
                }),
                (this.dataChannel.onclose = function () {
                  o.default.log('DC#' + e.connectionId + ' dc closed for:', e.peer),
                    e.close();
                });
            }),
            ...
            (s.prototype._sendChunks = function (e) {
              var n;
              var r;
              var a = i.util.chunk(e);
              o.default.log(
                'DC#' + this.connectionId + ' Try to send ' + a.length + ' chunks...'
              );
              try {
    ...
    Hxpd: [
      function (require, module, exports) {
        ...
        var s = require('./util');
        var a = o(require('./logger'));
        var c = require('./socket');
        var l = require('./mediaconnection');
        var d = require('./dataconnection');
        var u = require('./enums');
        var p = require('./api');
        var h = (function () {
          return function () {};
          ...
          return (
            ...
            (i.prototype.emitError = function (e, t) {
              ...
              a.default.error('Error:', t),
                ((n = typeof t === 'string' ? new Error(t) : t).type = e),
