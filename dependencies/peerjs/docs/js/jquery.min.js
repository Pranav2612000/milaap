...
(function (e, t) {
  ...
  (x.fn = x.prototype = {
    ...
    x.extend({
      ...
      map: function (e, t, n) {
        ...
        var s = [];
        if (a)
          for (; o > i; i++) (r = t(e[i], i, n)), r != null && (s[s.length] = r);
  ...
  (r = x(a)),
    (function (e, t) {
      ...
      function st() {
        ...
        function t(n, r) {
          return (
            e.push((n += ' ')) > o.cacheLength && delete t[e.shift()], (t[n] = r)
          );
        }
        return t;
      }
                ...
                function (t) {
                  ...
                  do
                    if (
                      ...
                      return (
                        (n = n.toLowerCase()), n === e || n.indexOf(e + '-') === 0
                      );
      ...
      function Ct(e, t) {
        ...
        var s = function (s, l, c, p, d) {
          ...
          var w = d != null;
          var C = u;
          var N = s || (a && o.find.TAG('*', (d && l.parentNode) || l));
          var k = (T += C == null ? 1 : Math.random() || 0.1);
      ...
      return (
        ...
        x(function () {
          ...
          l &&
            ...
            x.swap(l, l.style.zoom != null ? { zoom: 1 } : {}, function () {
  ...
  x.fn.extend({
    ...
    removeClass: function (e) {
      ...
      var a = 0;
      var s = this.length;
      var l = arguments.length === 0 || (typeof e === 'string' && e);
      if (x.isFunction(e))
        return this.each(function (t) {
  ...
  (x.event = {
    ...
    special: {
      ...
      click: {
        trigger: function () {
          return x.nodeName(this, 'input') && this.type === 'checkbox' && this.click
            ? (this.click(), !1)
            : t;
        },
        _default: function (e) {
        ...
        setup: function () {
          return x.nodeName(this, 'form')
            ...
            : (x.event.add(this, 'click._submit keypress._submit', function (e) {
                var n = e.target;
                var r =
                  x.nodeName(n, 'input') || x.nodeName(n, 'button') ? n.form : t;
                r &&
  ...
  x.fn.extend({
    ...
    is: function (e) {
      return !!ft(this, typeof e === 'string' && ut.test(e) ? x(e) : e || [], !1)
        .length;
    },
    closest: function (e, t) {
      ...
      var i = this.length;
      var o = [];
      var a = ut.test(e) || typeof e !== 'string' ? x(e, t || this.context) : 0;
      for (; i > r; r++)
        for (n = this[r]; n && n !== t; n = n.parentNode)
          if (
            n.nodeType < 11 &&
            (a ? a.index(n) > -1 : n.nodeType === 1 && x.find.matchesSelector(n, e))
          ) {
            n = o.push(n);
            break;
          }
  ...
  (At.optgroup = At.option),
    ...
    x.fn.extend({
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; i > r; r++)
                  (n = this[r] || {}),
                    n.nodeType === 1 && (x.cleanData(Ft(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      domManip: function (e, t, n) {
        ...
        if (
          g ||
          (!(c <= 1 || typeof h !== 'string' || x.support.checkClone) && Nt.test(h))
        )
  ...
  function nn(e, t) {
    return (
      (e = t || e), x.css(e, 'display') === 'none' || !x.contains(e.ownerDocument, e)
    );
  }
  function rn(e, t) {
    var n;
  ...
  function sn(e, t, n) {
    ...
    var o = Rt(e);
    var a = x.support.boxSizing && x.css(e, 'boxSizing', !1, o) === 'border-box';
    if (i <= 0 || i == null) {
        ...
        return on(
          ...
          r
            ? an(
                ...
                n,
                r,
                x.support.boxSizing && x.css(e, 'boxSizing', !1, i) === 'border-box',
                i
              )
            : 0
        );
  ...
  var Qn = {
    '*': [
      function (e, t) {
        ...
        var a = (x.cssNumber[e] || (o !== 'px' && +r)) && Yn.exec(x.css(n.elem, e));
        var s = 1;
        var l = 20;
        if (a && a[3] !== o) {
          (o = o || a[3]), (i = i || []), (a = +r || 1);
  ...
  function nr(e, t, n) {
    ...
    for (r in t)
      if (((i = t[r]), Vn.exec(i))) {
        if ((delete t[r], (o = o || i === 'toggle'), i === (f ? 'hide' : 'show')))
          continue;
